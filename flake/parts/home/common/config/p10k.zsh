# Generated by Powerlevel10k configuration wizard on 2020-11-09 at 19:34 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|stern'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|awsp|s3cmd'
