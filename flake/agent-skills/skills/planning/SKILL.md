...
1. 通常通り Plan Subagent を実行し、計画ファイルを作成する。
2. 作成された計画ファイルを元に、Codex にレビューと改善案の提示を依頼する。
3. Codex からのフィードバックを受け取り、計画ファイルを更新する。
4. 最低でも2往復のレビューと改善を繰り返す。
5. 最終的な計画ファイルをユーザーに提供する。
